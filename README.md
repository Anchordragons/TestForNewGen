...
Для запуска программы требуется установленный Node.js
Открываем папку filtered в терминале, пишем node filtered.js для запуска.

В data.js находятся все данные о курсах
